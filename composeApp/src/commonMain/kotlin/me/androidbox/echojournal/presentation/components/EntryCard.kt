    ...
    Card(
        ...
        Column(modifier = Modifier.fillMaxWidth(),
            ...
            Row(modifier = Modifier.fillMaxWidth(),
                ...
                Text(text = title, fontWeight = FontWeight.W500, color = Color.Black, fontSize = 16.sp)

                Text(text = time, fontWeight = FontWeight.Medium, color = Color.Gray, fontSize = 12.sp)
            }
